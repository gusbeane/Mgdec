...
\begin{enumerate}
    ...
    \item BH accretion increases: Following the increase in bar strength by about a snapshot ($\sim150\,\Myr$ here), the black hole accretion rate ($\dot{M_{\textrm{BH}}}/\dot{M_{\textrm{Edd}}}$) shows a significant spike, rising from a minimum of $\sim0.08$ at $t=2.84\,\Gyr$ to a maximum of $\sim0.29$ at $t=3.13\,\Gyr$.
    \item SFR declines: After the increase in black hole accretion, the star formation rate (SFR) begins to decline. The decrease in SFR is gradual and continues as the black hole accretion rate remains elevated. By approximately $3.2\,\textrm{Gyr}$, the SFR reaches a more quiescent state, where it remains relatively low.
\end{enumerate}
