...
\begin{table}[htb]
  ...
  \multicolumn{1}{l|}{$\dot{M}_{\textrm{BH}}/\dot{M}_{\textrm{Edd}}$} & $4.5\times10^{-5}$        
  \end{tabular}
  \caption{Summary statistics of our subhalo of interest at $z=0$ (392276). $M_{200}$ and $R_{200}$ are relative to the mean density of the universe, the SFR is for all gas bound to the subhalo, and the BH refers to the central BH.}
  \label{tab:summ}
\end{table}
...
The quantity of particular importance to our results is the star formation efficiency (SFE) timescale $\tau_\star$:
\begin{equation}
...
In Figure~\ref{fig:fig1}, we showed that a time-linear $\alpha$-enhancement of older stars (formed before $z=1.5$) leads to the emergence of a pronounced chemical bimodality. This $\alpha$-enhancement corresponds to a more rapid decline in \alphaFe{} over time at high redshifts. Figure~\ref{fig:vice} suggests that a low SFE at high densities may plausibly explain the absence of a steep decline in \alphaFe{} in the fiducial TNG model.
