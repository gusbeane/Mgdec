...
\begin{figure*}
  ...
  \caption{The abundance plane made in a manner similar to Figure~\ref{fig:fig1}. We show }
  \label{fig:app0}
\end{figure*}

\figsetstart
\figsetnum{7}
\figsettitle{Abundance plane for a random subset of sample galaxies in this work.}
\figsetgrpstart
\figsetgrpnum{7.1}
\figsetgrptitle{Abundance plane for subhalo 392276.}
\figsetplot{app_172175.pdf}
\figsetgrpnote{Abundance plane for subhalo 392276.}
\figsetgrpend
\figsetgrpstart
\figsetgrpnum{7.1}
\figsetgrptitle{Abundance plane for subhalo 172175.}
\figsetplot{app_172175.pdf}
\figsetgrpnote{Abundance plane for subhalo 172175.}
\figsetgrpend
\figsetend
